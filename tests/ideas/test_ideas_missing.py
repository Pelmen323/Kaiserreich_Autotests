...
def test_check_ideas_missing(test_runner: object):
    ...
    defined_ideas = Ideas.get_all_ideas_names(
        test_runner=test_runner,
        lowercase=True,
        return_paths=False,
        include_country_ideas=True,
        include_manufacturers=True,
        include_characters_tokens=True,
        include_laws=True,
        include_army_spirits=True,
    )
    ...
    ResultsReporter.report_results(results=results, paths=paths, message="Missing ideas were encountered.")
