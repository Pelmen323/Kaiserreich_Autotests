...
# 3. throw the error if those combinations are encountered
    ResultsReporter.report_results(results=results, message="Usage of triggers that include 'has_capitulated', 'has_war', and 'surrender_progress' at the same time is encountered.")
