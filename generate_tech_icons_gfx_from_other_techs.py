...
INPUT_LIST = [
    # ['motorized_equipment_0_medium', 'tech_trucks_medium'],
    ...
    ['transport_plane_equipment_1_medium', 'early_transport_plane_medium'],
    ['transport_plane_equipment_2_medium', 'improved_transport_plane_medium'],
    ['transport_plane_equipment_3_medium', 'strategic_airlifter_medium'],
    # ['jet_fighter2_medium', 'small_plane_airframe_5_medium'],
    # ['guided_missile_equipment_2_medium', 'ballistic_missile_equipment_1_medium'],
    # ['guided_missile_equipment_3_medium', 'ballistic_missile_equipment_2_medium'],
]
SAME_FILE = True
